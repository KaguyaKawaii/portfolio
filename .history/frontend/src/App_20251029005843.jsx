...
function App() {
  ...
  return (
    <>
      <header className='bg-[#0F0E0E] h-16 md:h-[90px] w-full shadow-lg shadow-[#dc143c] fixed top-0 z-50'>
        <div className='flex justify-between items-center h-full px-4 md:px-8 lg:justify-around text-white'>
          <h1 className='font-bold font-montserrat text-xl md:text-[25px]'>My Portfolio</h1>
          
          {/* Desktop Navigation */}
          <nav className='hidden lg:flex font-montserrat gap-6 font-semibold text-lg md:text-[20px]'>
            <button
              onClick={() => {
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="lg:hidden bg-[#0F0E0E] absolute top-16 left-0 right-0 shadow-lg shadow-[#dc143c]">
            <div className="flex flex-col py-4 font-montserrat font-semibold text-lg">
              <button
                onClick={() => {
                  document.getElementById("home").scrollIntoView({ behavior: 'smooth' });
                  setIsMenuOpen(false);
      ...
      <main className='bg-linear-180 from-[#1E1E1E] to-[#0F0E0E] text-white pt-16 md:pt-[90px]'>
        {/* Home Section */}
        <section id='home' className='min-h-screen flex flex-col lg:flex-row justify-center items-center px-4 md:px-8 lg:px-16 py-8 lg:py-0'>
          <div className='order-2 lg:order-1 text-center lg:text-left lg:w-1/2 lg:pr-8'>
            ...
            <div className='mt-6 animate-fade-in'>
              ...
              <div className='m-4 md:m-6 flex justify-center lg:justify-start'>
                <button className='ring-1 ring-red-500 text-red-500 rounded-3xl w-full md:w-[250px] p-3 text-center hover:text-gray-800 hover:bg-white hover:ring-gray-800 transition-all duration-300 cursor-pointer hover:font-semibold'>
                  Download Resume
                </button>
              </div>

              <div className='flex justify-center lg:justify-start gap-4 md:gap-6 pt-6 md:pt-[50px]'>
                {/* Email */}
                <a
                  href="mailto:stephenpatingomadero@gmail.com"
                  className="text-gray-800 hover:text-red-600 transition bg-white rounded-full p-2 w-10 h-10 md:w-[50px] md:h-[50px] text-lg md:text-2xl flex justify-center items-center hover:scale-110"
                >
                  <MdEmail />
                </a>
          ...
          <div className='order-1 lg:order-2 lg:w-1/2 mb-8 lg:mb-0 flex justify-center'>
            <img
              src={pic}
              alt="profile"
              className="w-64 h-64 md:w-80 md:h-80 lg:w-full lg:h-full max-w-md object-cover rounded-2xl lg:rounded-4xl"
              style={{
        ...
        <div className='flex justify-center items-center text-gray-700 text-sm md:text-lg font-montserrat font-semibold animate-pulse pb-10 md:pb-10 w-full'>
          Scroll down
        </div>
        
        {/* Skills Section */}
        <section className='w-full py-12 md:py-20 bg-[#1E1E1E]'>
          <div className='flex gap-4 md:gap-6 justify-center items-center min-h-[20vh] font-semibold text-2xl md:text-3xl text-white px-4'>
            <div className="flex flex-wrap gap-4 md:gap-6 justify-center w-full max-w-7xl">
              <div className="flex flex-wrap gap-4 md:gap-6 justify-center text-white w-full">
                {/* HTML5 */}
        ...
        <section id='about' className='w-full py-12 md:py-20 bg-[#1E1E1E] px-4 md:px-8'>
          <h1 className='text-white font-montserrat text-3xl md:text-4xl font-bold text-center pb-8 md:pb-12'>About Me</h1>
          <div className='max-w-4xl mx-auto'>
            <p className='text-gray-200 font-montserrat text-center text-base md:text-lg leading-relaxed md:leading-loose'>
        ...
        <section id='project' className='w-full py-12 md:py-20 bg-[#1E1E1E] px-4 md:px-8'>
          <h1 className='text-white font-montserrat text-3xl md:text-4xl font-bold text-center pb-8 md:pb-12'>Project</h1>
            ...
            <div className='flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 min-h-[500px]'>
              ...
              <div className='lg:w-1/2 flex justify-center'>
                <a href="https://circulink-beta-testing.vercel.app/" target="_blank" rel="noopener noreferrer">
                  <img 
                    src={project}
                    className='rounded-2xl shadow-2xl hover:shadow-red-800 transition-all duration-500 hover:scale-105 w-full max-w-lg lg:max-w-full h-auto'
              ...
              <div className='lg:w-1/2 text-center lg:text-left'>
                <h1 className='text-2xl md:text-3xl lg:text-4xl font-semibold'>CircuLink</h1>
                ...
                <p className="mt-2 text-gray-200 text-sm md:text-base lg:text-lg w-full lg:max-w-[550px]">
        ...
        {/* Contact Section */}
        <footer id="contact" className="w-full py-12 md:py-16 bg-[#0F0E0E] text-white text-center px-4 md:px-8">
