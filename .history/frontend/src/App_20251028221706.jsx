        ...
        <div className='flex justify-around items-center h-screen'>
          <div>
            ...
            <div className='mt-6 animate-fade-in'>
              <p className='font-semibold text-5xl'>I'm a  <span className="drop-shadow-[0_0_50px_#dc143c] text-red-500 animate-pulse delay-75">Frontend Web Developer</span></p>
