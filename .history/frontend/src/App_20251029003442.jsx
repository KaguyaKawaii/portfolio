...
<p className="text-[#dc143c] font-medium">Capstone Project | Web-Based Library Room Reservation System</p>
<p className="mt-2 text-gray-700">
  CircuLink is an innovative platform designed to modernize the library room booking process. 
  It allows students and faculty to reserve rooms with ease, track availability in real-time, and manage reservations efficiently — 
  providing a smarter, more accessible way to organize academic spaces.
</p>
                  </div>
