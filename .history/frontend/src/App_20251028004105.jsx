...
function App() {
 ...
 <div className="flex flex-col items-center hover:scale-110 transition-transform">
  <i
    className="devicon-vitejs-plain text-5xl bg-gradient-to-tr from-[#FFD62E] via-yellow-400 to-[#646CFF] text-transparent bg-clip-text"
  ></i>
  <span className="mt-2 font-medium text-gray-200">Vite</span>
</div>
