...
function App() {
  ...
  <div className="flex items-center space-x-2">
    <i className="devicon-html5-plain text-orange-500 text-3xl"></i>
    <span>HTML5</span>
  </div>
  <div className="flex items-center space-x-2">
    <i className="devicon-css3-plain text-blue-500 text-3xl"></i>
    <span>CSS3</span>
  </div>
  <div className="flex items-center space-x-2">
    <i className="devicon-javascript-plain text-yellow-400 text-3xl"></i>
    <span>JavaScript</span>
  </div>
  <div className="flex items-center space-x-2">
    <i className="devicon-react-original text-cyan-400 text-3xl"></i>
    <span>React.js</span>
  </div>
  <div className="flex items-center space-x-2">
    <i className="devicon-vitejs-plain text-purple-500 text-3xl"></i>
    <span>Vite</span>
  </div>
</div>
