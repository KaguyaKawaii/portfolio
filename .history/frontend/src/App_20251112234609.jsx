...
function App() {
  ...
  return (
    <>
      ...
      <main className={`${isDarkMode ? 'bg-gradient from-[#1E1E1E] to-[#0F0E0E]' : 'bg-gradient from-gray-100 to-white'} min-h-screen ${isDarkMode ? 'text-white' : 'text-gray-900'} pt-[70px] md:pt-[90px] transition-colors duration-300`}>
