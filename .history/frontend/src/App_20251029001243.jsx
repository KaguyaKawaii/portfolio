          ...
          <div>
            ...
            <div className='mt-6 animate-fade-in'>
              ...
              <div className='m-6'>
                  ...
                  <p className='ring-1 ring-red-500 text-red-500 rounded-3xl w-[250px] p-3 text-center hover:text-gray-800 hover:bg-white hover:ring-gray-800 transition-all duration-300 cursor-pointer'>Download Resume</p>
