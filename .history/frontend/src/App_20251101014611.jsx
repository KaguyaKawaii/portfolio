            ...
            <div className="flex flex-wrap gap-3 md:gap-4 lg:gap-6 justify-center">
              <div className="flex flex-wrap gap-3 md:gap-4 lg:gap-6 justify-center text-white">
                ...
                <div className="flex items-center hover:scale-110 transition-all ring-1 hover:ring-red-100 rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-html5-plain text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
                  <p className='text-sm md:text-base lg:text-lg text-gray-800 font-semibold'>HTML</p>
                  <div className="absolute bottom-0 left-0 w-full h-1 bg-red-500 rounded-full scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
                </div>
                ...
                <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-css3-plain text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
                ...
                {/* JavaScript */}
                <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-javascript-plain text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
                ...
                {/* React.js */}
                <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-react-original text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
                ...
                {/* Node.js */}
                <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-nodejs-plain text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
                ...
                {/* Express.js */}
                <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-express-original text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
                ...
                {/* MongoDB */}
                <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-mongodb-plain text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
                ...
                {/* GitHub */}
                <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-3 md:p-4 lg:p-5 gap-2 md:gap-3 lg:gap-4 bg-white shadow-lg hover:shadow-red-500 duration-500 hover-lift group">
                  <i className="devicon-github-original text-red-500 text-2xl md:text-3xl lg:text-4xl"></i>
              ...
              <div className='flex flex-col lg:flex-row items-center justify-between min-h-[400px] md:min-h-[500px] gap-8 md:gap-12 lg:gap-16 hover-lift'>
                ...
                <div className='text-center lg:text-left w-full lg:w-1/2'>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4 justify-center lg:justify-start">
                    ...
                    <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-medium">Node.js</span>
                    <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-medium">MongoDB</span>
                    <span className="bg-red-500 text-white px-3 py-1 rounded-full text-sm font-medium">Express</span>
                  </div>
