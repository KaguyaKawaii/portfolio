        ...
        <div className='flex justify-around items-center h-screen'>
          <div>
            <div className='text-2xl'>
              <h1 className='font-semibold delay-[1s,250ms] ease-in'>Hi There!</h1>
              <p>Im Stephen</p>
            </div>
            <div className='mt-6 animate-fade-in'>
              <p className='font-semibold text-5xl'>I'm a  <span className="drop-shadow-[0_0_50px_#dc143c] text-red-500">Frontend Web Developer</span></p>
          ...
          <div className='h-screen'>
            ...
            <div className='flex gap-6 justify-center items-center h-[20vh] font-semibold text-3xl text-white'>
              <div className="flex flex-wrap gap-6 justify-center">
                ...
                <div className="flex flex-wrap gap-6 justify-center text-white animate-slide">
                  {/* HTML5 */}
                  ...
                  {/* Vite */}
                  <div className="flex items-center hover:scale-110 transition-transform">
                    <i className="devicon-vitejs-plain text-purple-700 text-5xl"></i>
                  ...
                  {/* Express.js */}
                  <div className="flex items-center hover:scale-110 transition-transform">
                    <i className="devicon-express-original text-gray-300 text-5xl"></i>
