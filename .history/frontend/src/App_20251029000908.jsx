        ...
        <div id='home' className='flex justify-around items-center h-screen'>
          <div>
            ...
            <div className='mt-6 animate-fade-in'>
              ...
              <div className='flex gap-6 t-6'>
                {/* Email */}
              <a
                href=""
                className="text-gray-800 hover:text-red-500 transition bg-white rounded-full p-2  w-[50px] h-[50px] text-2xl flex justify-center items-center"
              >
                <MdEmail />
              </a>
