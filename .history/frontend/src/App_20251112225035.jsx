  ...
  return (
    <>
      <header className='bg-[#1E201E] h-[70px] md:h-[90px] w-full shadow-sm shadow-[#dc143c] fixed top-0 z-50'>
        <div className='flex justify-between items-center h-full text-white px-4 md:px-8 lg:px-20'>
          ...
          <div className='hidden md:flex font-montserrat gap-4 lg:gap-6 font-semibold text-[16px] lg:text-[18px]'>
            <button
              ...
              className="hover:text-red-500 duration-300 cursor-pointer relative group"
            >
              <p>Home</p>
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden bg-[#0F0E0E] absolute top-full left-0 w-full shadow-lg transition-all duration-300 ${
        ...
        <div id="contact" className="min-h-[40vh] flex flex-col items-center justify-center bg-[#0F0E0E] text-white text-center px-4 md:px-8 py-12 md:py-16">
          ...
          <div className='flex flex-wrap justify-center gap-3 md:gap-4 lg:gap-6 mb-6 md:mb-8'>
            <button
              ...
              className="hover:text-red-500 duration-300 cursor-pointer text-sm md:text-base relative group"
            >
              <p>Home</p>
              <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-red-500 transition-all group-hover:w-full"></span>
            </button>
