            ...
            <h1 className='text-white font-montserrat text-4xl font-bold text-center pt-20'>Project</h1>
              ...
              <div className='flex flex-col'>
                <div className='flex items-center justify-between mx-50  h-[600px]'>
                  ...
                  <div>
                    <a className='rounded-2xl shadow-2xl hover:shadow-red-800 transition-all duration-500 hover:scale-110 w-[800px] h-[500px]' href="https://circulink-beta-testing.vercel.app/" target="_blank" rel="">
                    <img src={project}
