...
function App() {
  ...
  return (
    <>
      ...
      <main className={`${isDarkMode ? 'bg-linear-180 from-[#1E1E1E] to-[#0F0E0E]' : ' from-gray-100 to-white'} min-h-screen ${isDarkMode ? 'text-white' : 'text-gray-900'} pt-[70px] md:pt-[90px] transition-colors duration-300`}>
