...
function App() {
  ...
  return (
    <>
      <header className='bg-[#0F0E0E] h-[90px] w-full absolute shadow-lg shadow-[#dc143c] fixed'>
        <div className='flex justify-around items-center h-full text-white'>
          ...
          <div className='flex font-montserrat gap-6 font-semibold text-[20px]'>
            ...
            <button
              ...
              className="cursor-pointer hover:border-b-6 rounded-full hover:border-red-500 transition-all duration-500"
            >
