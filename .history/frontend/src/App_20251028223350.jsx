            ...
            <div className='flex gap-6 justify-center items-center h-[20vh] font-semibold text-3xl text-white'>
              <div className="flex flex-wrap gap-6 justify-center">
                ...
                <div className="flex flex-wrap gap-6 justify-center text-white">
                  {/* HTML5 */}
                  <div className="flex items-center hover:scale-110 transition-all ring-1 hover:ring-red-600 rounded-lg p-5 gap-5 bg-white shadow-lg hover:shadow-red-500 duration-500">
