            ...
            <div className='flex gap-6 justify-center items-center h-[20vh] font-semibold text-3xl text-white'>
              <div className="flex flex-wrap gap-6 justify-center">
                ...
                <div className="flex flex-wrap gap-6 justify-center text-white animate-slide">
                  {/* HTML5 */}
                  <div className="flex items-center hover:scale-110 transition-transform border rounded-lg p-5 gap-5 bg-white/10 shadow-lg shadow-red-800">
                    <i className="devicon-html5-plain text-orange-500 text-5xl"></i>
                    <p className='text-2xl text-gray-200 font-semibold'>HTML</p>
                  </div>
