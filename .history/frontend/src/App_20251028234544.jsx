...
function App() {
  ...
  <div className="flex justify-center gap-6 text-2xl">
    <a href="mailto:stephenmadero.dev@gmail.com" className="hover:text-[#dc143c] transition">📧</a>
    <a href="https://github.com/stephenmadero" target="_blank" className="hover:text-[#dc143c] transition">💻</a>
    <a href="https://twitter.com/stephenmadero" target="_blank" className="hover:text-[#dc143c] transition">🐦</a>
    <a href="https://instagram.com/stephenmadero" target="_blank" className="hover:text-[#dc143c] transition">📷</a>
    <a href="https://facebook.com/stephenmadero" target="_blank" className="hover:text-[#dc143c] transition">📘</a>
  </div>
</section>
